    ...
    <div class="content-wrapper" style="background-color: #4C0070;">
        ...
        <div style="display: flex; justify-content: left;">
            ...
            <div class="card" style="width: 18rem;background-color: #4C0070; ">
                <img style="padding: 14px;" src="./assets/images/hijab.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h2 style="text-align: center; ">Hijab</h2>
                </div>
            ...
            <div class="card" style="width: 18rem; background-color: #4C0070;">
                <img style="padding: 14px;" src="./assets/images//Shopping_Cart_free_icons_designed_by_Freepik-removebg-preview.png" height="75%" width="" class="card-img-top" alt="...">
                <div class="card-body">
